      ...
      >
        ...
        <div className="px-2 pb-2 border-t border-gray-100 bg-gray-50">
          <Button
            ...
            className="flex items-center w-full px-4 py-3 mt-2 text-sm font-medium text-red-600 rounded-lg transition-all duration-200 hover:bg-red-50 hover:text-red-700 group"
          >
            <div className="flex items-center justify-center w-8 h-8 mr-3 text-red-500 bg-red-100 rounded-lg transition-all duration-200 group-hover:bg-red-200">
              <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                <path
                  fillRule="evenodd"
                  clipRule="evenodd"
